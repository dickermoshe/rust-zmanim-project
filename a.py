...
matches = re.findall(r"public (.+) (.+)\(", a)
# Remove ones which start with set..
matches = [match for match in matches if not match[1].startswith("set")]
# Skip equals and hashcode
matches = [
    match
    for match in matches
    if match[1] != "equals" and match[1] != "hashCode" and match[1] != "toString"
]
type_map = {
    "boolean": "bool",
    "int": "i32",
